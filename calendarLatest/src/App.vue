...
import { type Day } from "../src/types/OwnDays"
...
const defineCalendar = (days_array:Day[], mnth:string) => {
  month.value = mnth;
  owndays.value = days_array;
}
...
const sendColor = () => {
  return currentTheme.value === "black" ? "black" : "light";
}
</script>
<style lang="scss">
.container{
